...
public class TileTinyCrate extends TileEntity implements IInventory, IItemHandler {
    public ItemStack[] inventory;
    public String customName;

    public TileTinyCrate() {
    ...
    public String getName() {
        return this.hasCustomName() ? this.customName : "container.avionics.aviontinychest";
    }
