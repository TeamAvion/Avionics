...
/**
 * Created by Deathly on 12/4/2016 at 5:05 AM.
 */
public class TileSmallCrate extends TileEntity implements IInventory,IItemHandler {
    public ItemStack[] inventory;
    public String customName;

    public TileSmallCrate() {
    ...
    public String getName() {
        return this.hasCustomName() ? this.customName : "container.avionics.minichest";
    }

    @Override
    public boolean hasCustomName() {
        return this.customName != null && !this.customName.equals("Tiny Chest");
    }
